...
title and the split, detach, and add-pane rows are asserted as drawn rather than as modelled. The
live launcher fixture at M8-06 will prove a selected valid profile reaches the actor and creates the
named pane without treating ordinary shell input as a command.
