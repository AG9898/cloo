...
shorter list, refreshing leaves another overlay's rows alone, and `!` is offered by the help surface
only while the keymap leaves it free. Legibility is asserted at all four states the milestone names:
