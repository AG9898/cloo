...
1. Read `AGENTS.md` first to understand the project's doc structure and routing.
...
- Use `request_user_input` to present clarifying questions with 2–4 concrete option choices and a short header. Do not output questions as plain terminal text.
...
- Never assume specific group IDs, doc paths, or field names from other repos — consult `AGENTS.md` for project-specific conventions.
